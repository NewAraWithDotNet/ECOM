...
namespace OnlineOrderingSystem.Migrations
{
    ...
    [Migration("20240711081200_productCommiteTrue")]
    partial class productCommiteTrue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineOrderingSystem.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineOrderingSystem.Models.Wishlist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OnlineOrderingSystem.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineOrderingSystem.Models.CartItem", b =>
                {
                    b.HasOne("OnlineOrderingSystem.Models.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("OnlineOrderingSystem.Models.ChatMessage", b =>
                {
                    b.HasOne("OnlineOrderingSystem.Models.Conversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("OnlineOrderingSystem.Models.Conversation", b =>
                {
                    ...
                    b.HasOne("OnlineOrderingSystem.Models.User", "User2")
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineOrderingSystem.Models.OrderItem", b =>
                {
                    b.HasOne("OnlineOrderingSystem.Models.Order", "Order")
                        .WithMany("OrderItems")
